...
jQuery(function($){
    $(".fancybox, [rel='lightbox[myImageSet]']").fancybox();



    $(".checkbox label").click(function(evt){
    	evt.stopPropagation();
		evt.preventDefault();
...
//
	// var images = [
	     // "/fileadmin/user_upload/Hintergruende/rsw-radsport_hintergrund1.jpg"
	    // ,"/fileadmin/user_upload/Hintergruende/rsw-radsport_hintergrund2.jpg"
	    // ,"/fileadmin/user_upload/Hintergruende/rsw-radsport_hintergrund3.jpg"
	    // ,"/fileadmin/user_upload/Hintergruende/rsw-radsport_hintergrund4.jpg"
	// ];

	// $.backstretch(shuffle(images), {duration: 5000, fade: 750, });
	...
	$('.bxslider .csc-textpic-imagewrap').bxSlider({
		randomStart: true,
		auto: true,
		nextText: '>',
		prevText: '<'
